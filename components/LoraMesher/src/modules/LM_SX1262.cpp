...
// LM_SX1262::LM_SX1262(uint8_t loraCs, uint8_t loraIrq, uint8_t loraRst, uint8_t loraIo1, SPIClass* spi) {
    LM_SX1262::LM_SX1262(EspHal* hal, uint8_t loraCs, uint8_t loraIrq, uint8_t loraRst, uint8_t loraIo1) {
    // Initialize the SX1276 module with the given parameters
    module = new SX1262(new Module(hal, loraCs, loraIrq, loraRst, loraIo1));
}
