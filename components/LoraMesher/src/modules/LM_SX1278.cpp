...
#include <esp_log.h>
    ...
    LM_SX1278::LM_SX1278(EspHal* hal, uint8_t loraCs, uint8_t loraIrq, uint8_t loraRst, uint8_t loraIo1) {
    // Initialize the SX1276 module with the given parameters
    module = new SX1278(new Module(hal, loraCs, loraIrq, loraRst, loraIo1));
}
