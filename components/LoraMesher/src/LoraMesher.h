...
public:
     ...
     * @return LoraMesher&
     */
    void runSendHelloPacketRoutine(); // Méthode membre qui contient la logique principale
...
#ifndef LM_GOD_MODE
private:
//TimerHandle_t Hello_TimerHandle;
#endif
     ...
     */
     ...
     //TaskHandle_t Hello_TaskHandle = nullptr;;  // Task handle
     //void sendHelloPacket(); // Instance method
    // Other members..
    /**
